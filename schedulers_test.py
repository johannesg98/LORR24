...
env = envWrapper.LRRenv(
    inputFile="./League_of_Robot_Runners/example_problems/custom_warehouse.domain/warehouse_8x6.json",  # options: warehouse_6x4, warehouse_8x6, warehouse_9x8, warehouse_13x12, warehouse_24x15
    outputFile="./GRAND/outputs/schedulers_test.json",
...
for i in range(number_of_runs):
    ...
    while not done:
        ...
        if done:
            np.save(os.path.join(script_dir, f"GRAND/outputs/pibt_wait_map_test.npy"), np.array(info["pibt-wait-map"]))
