...
class GNNActor(nn.Module):
    def __init__(self, in_channels, hidden_size=32, act_dim=6, edge_limit=0.5, out_channel_fac=2):
        ...
        self.conv1 = GATConv(in_channels, self.out_channels, edge_dim=1)
        ...
        self.conv2 = GATConv(self.conv2_in_channels, self.conv2_out_channels, edge_dim=1)
        self.lin4 = nn.Linear(self.conv2_in_channels + self.conv2_out_channels, 1)
