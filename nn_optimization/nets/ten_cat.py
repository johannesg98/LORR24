...
class GNNActor(nn.Module):
    ...
    def forward(self, state, edge_index, deterministic=False, return_dist=False, return_raw=False):
        ...
        out6 = F.relu(self.conv3(out5, edge_index))
        out7 = F.relu(self.conv3(out6, edge_index))
        out8 = F.relu(self.conv3(out7, edge_index))
        out9 = F.relu(self.conv3(out8, edge_index))
        out10 = F.relu(self.conv3(out9, edge_index))
