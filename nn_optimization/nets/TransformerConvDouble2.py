...
class GNNActor(nn.Module):
    def __init__(self, in_channels, hidden_size=32, act_dim=6, edge_limit=0.5, out_channel_fac=2):
        ...
        self.conv3 = TransformerConv(self.conv2_in_channels, self.conv2_out_channels, edge_dim=1)
    ...
    def forward(self, state, edge_index, deterministic=False, return_dist=False, return_raw=False):
        ...
        out3 = F.relu(self.conv3_norm(self.conv3(batch.x, batch.edge_index, edge_attr=batch.edge_attr)))
        out3 = out3.reshape(-1, self.act_dim, self.conv2_out_channels)
